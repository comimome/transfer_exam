...
\begin{align*}
  ...
  \sqrt{10} + 1 \ge \mathrm{r} \ge \sqrt{10} - 1
\end{align*}
...
\begin{align*}
  ...
  {\mathrm{r}}^2 = \{\sqrt{10} - \lvert\mathrm{AF}\lvert\}^2 + \frac{5}{9}
\end{align*}

整理すると

\begin{align*}
  {\mathrm{r}}^2 = \{\sqrt{10} - \sqrt{1 - \frac{5}{9}}\}^2 + \frac{5}{9} = 11 - \frac{4\sqrt{10}}{3} \\
